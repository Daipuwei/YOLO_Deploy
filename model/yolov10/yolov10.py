...
class YOLOv10(DetectionModel):
    ...
    def __init__(self,logger,cfg,gpu_id=0,**kwargs):
        ...
        super(YOLOv10,self).__init__(logger=logger,
                                    engine=engine,
                                    ...
                                    gpu_id=gpu_id,
                                    **kwargs)
        self.logger.info("初始化YOLOv10检测模型成功")
...
def yolov10(logger,cfg,**kwargs):
    ...
    Returns:
    """
    model = YOLOv10(logger,cfg,**kwargs)
    return model
