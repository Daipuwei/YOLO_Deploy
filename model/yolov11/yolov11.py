...
class YOLOv11(DetectionModel):
    ...
    def __init__(self,logger,cfg,gpu_id=0,**kwargs):
        ...
        super(YOLOv11,self).__init__(logger=logger,
                                    engine=engine,
                                    ...
                                    gpu_id=gpu_id,
                                    **kwargs)
        self.logger.info("初始化YOLOv11检测模型成功")
...
def yolov11(logger,cfg,**kwargs):
    ...
    Returns:
    """
    model = YOLOv11(logger,cfg,**kwargs)
    return model
