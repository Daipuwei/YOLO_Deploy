...
class YOLOv9(DetectionModel):
    ...
    def __init__(self,logger,cfg,gpu_id=0,**kwargs):
        ...
        super(YOLOv9,self).__init__(logger=logger,
                                    engine=engine,
                                    ...
                                    gpu_id=gpu_id,
                                    **kwargs)
        self.logger.info("初始化YOLOv9检测模型成功")
...
def yolov9(logger,cfg,**kwargs):
    ...
    Returns:
    """
    model = YOLOv9(logger,cfg,**kwargs)
    return model
