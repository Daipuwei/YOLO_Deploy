...
class TensorRT_Engine(object):
    ...
    def __init__(self,logger,onnx_model_path,tensorrt_model_path,input_name,
                 output_name,input_shape,output_shape,gpu_idx=0,mode="fp32",trt_int8_calibrator=None):
        """
    ...
    def inference(self,input_tensor):
        ...
        [np.copyto(_inp.host, input_tensor.ravel()) for _inp in self.input]
        # Push to device
        ...
        # Pop the device
        self.device_ctx.pop()
        host_outputs = [out.host.reshape(self.output_shape) for out in self.output[::-1]]
