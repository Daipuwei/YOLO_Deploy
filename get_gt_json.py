...
parser.add_argument('--choices', nargs='+', type=str,help='VOC dataset subdataset choices')
...
def run_main():
    ...
    coco_dataset_dir = os.path.abspath(opt.coco_dataset_dir)
    class_name_path = os.path.abspath(opt.class_name_path)
