...
parser.add_argument('--input_dir', type=str, help="gt and dr directory")
...
GT_PATH = os.path.join(args.input_dir, 'ground-truth')
DR_PATH = os.path.join(args.input_dir, 'detection-results')
...
"""
TEMP_FILES_PATH = os.path.join(args.input_dir,".temp_files")
if not os.path.exists(TEMP_FILES_PATH): # if it doesn't exist already
    os.makedirs(TEMP_FILES_PATH)
output_files_path = os.path.join(args.input_dir,"output")
